...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { kind: 'item', label: 'General Ledger', href: '/dashboard/finance/general-ledger', icon: <BookIcon /> },
  ...
  },
  {
    ...
    entries: [
      ...
      { kind: 'item', label: 'Payroll Setup', href: '/dashboard/payroll/setup', icon: <UsersIcon /> },
      { kind: 'item', label: 'Tax Schedules', href: '/dashboard/payroll/tax', icon: <FileTextIcon /> },
      { kind: 'sub', label: 'Processing' },
      { kind: 'item', label: 'Run Payroll', href: '/dashboard/payroll/runs', icon: <BanknoteIcon /> },
      { kind: 'item', label: 'Schedule', href: '/dashboard/payroll/schedule', icon: <CalendarIcon /> },
      { kind: 'item', label: 'Loans & Advances', icon: <CoinIcon />, locked: true },
      { kind: 'sub', label: 'Disbursement' },
      { kind: 'item', label: 'Wallet', href: '/dashboard/payroll/wallet', icon: <CreditCardIcon /> },
  ...
  },
  {
    ...
    entries: [
      ...
      { kind: 'item', label: 'Statutory Summary', href: '/dashboard/compliance/tax-center', icon: <ShieldCheckIcon /> },
      { kind: 'item', label: 'Tax Schedules', href: '/dashboard/payroll/tax', icon: <FileTextIcon /> },
      { kind: 'sub', label: 'E-Invoicing (NRS/FIRS)' },
      { kind: 'item', label: 'NRS-MBS Integration', icon: <ReceiptIcon />, locked: true },
      { kind: 'item', label: 'Invoice Transmission', icon: <FileTextIcon />, locked: true },
      { kind: 'item', label: 'IRN Tracking', icon: <FileTextIcon />, locked: true },
      { kind: 'item', label: 'Acknowledgements', icon: <FileTextIcon />, locked: true },
  ...
  },
  {
    ...
    entries: [
      ...
      { kind: 'sub', label: 'Expense Management' },
      { kind: 'item', label: 'Expense Claims', href: '/dashboard/operations/expense-claims', icon: <ReceiptIcon /> },
      { kind: 'item', label: 'Advances', href: '/dashboard/operations/advances', icon: <CoinIcon /> },
    ],
  },
  {
    key: 'intelligence',
